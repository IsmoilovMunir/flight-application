...
public class Flight {
    ...
    public Flight(long id, String flightNo, String departureDate, String departureAirportCode, Object arrivalDate, String arrivalAirportCode, int aircraftId, String status) {
    }
